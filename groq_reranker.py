"""
RAG System with Retriever, RRF and Reranker using Groq
Combines BM25 + Embeddings + LLM Reranking
CORRECTED VERSION - f-strings properly closed
"""
...
def reranker_fn(docs, query_text, k):
    ...
    prompt = (
        ...
        "Your task is to select and sort the " + str(k) + " most relevant documents to answer the user's question.\n\n"
        ...
        "```json\n"
        "{{\n"
        '    "document_ids": string[] # List document ids, ' + str(k) + ' elements long, sorted in order of decreasing relevance to the user\'s query. The most relevant documents should be listed first.\n'
        "}}\n"
        "```"
    )
...
# ============================================
# 9. COMPLETE RAG FUNCTION
# ============================================

def answer_with_reranker(query, retriever, k=2):
    """
    Answers a question using the Retriever with reranker
    """
    print(f"\n📌 Question: {query}")
    print("=" * 60)
...
if __name__ == "__main__":
    print("🚀 RAG SYSTEM WITH RETRIEVER, RRF AND RERANKER")
    print("=" * 70)
    ...
    # 6. Test searches
    print("\n" + "=" * 70)
    print("🔍 SEARCH TESTS WITH RERANKER")
    print("=" * 70)

    # Specific challenge question
    ...
    answer, results = answer_with_reranker(question, retriever, k=2)
    print(f"\n✅ Answer:\n{answer}\n")

    print("\n" + "=" * 70)
    print("✅ DEMONSTRATION COMPLETED")
    print("\n📌 SYSTEM FEATURES WITH RERANKER:")
    print("   ✅ Multiple indexes (BM25 + Embeddings)")
    print("   ✅ Rank fusion (RRF)")
    print("   ✅ LLM reranking (Groq)")
    print("   ✅ Higher precision results")